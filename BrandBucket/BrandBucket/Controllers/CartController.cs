...
namespace BrandBucket.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public CartController(ApplicationDbContext db, IWebHostEnvironment webHostEnvironment, IEmailSender emailSender,
            IApplicationUserRepository userRepo, IProductRepository prodRepo, IInquiryHeaderRepository inqHRepo,
        ...
        public IActionResult IndexPost(IEnumerable<Product> ProdList)
        {
            ...
            {
                shoppingCartList.Add(new ShoppingCart { ProductId = prod.Id, Quantity = prod.TempQty });
            }
